...
export function Minimap({ locations, currentLocationId }: MinimapProps) {
  ...
  if (discoveredLocations.length === 0) {
    return (
      <div className="text-center py-6">
        ...
        <p className="text-xs text-slate-400 mt-1">Explore the world to reveal the map</p>
      </div>
    );
  }
  ...
  const currentLoc = discoveredLocations.find(l => l.id === currentLocationId);
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="border-t border-slate-200 pt-3 mt-3">
        <p className="text-xs font-medium text-slate-500 mb-2">Discovered Locations</p>
