...
export const MessageBubble = memo(function MessageBubble({
  ...
  const variantContainerStyles: Record<MessageVariant, string> = {
    ...
    system:
      "bg-blue-50 rounded-lg border border-blue-200 text-blue-800 text-center",
    narration:
      "bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl border border-indigo-200 italic text-slate-700",
  };
              ...
              {isTyping ? (
                ...
                <>
                  ...
                  <button
                    ...
                    title={
                      copied
                        ? t("message.copied", "Copied!")
                        : t("message.copy", "Copy message")
                    }
                    aria-label={
                      copied
                        ? t("message.copied", "Copied!")
