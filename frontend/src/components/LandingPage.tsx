    ...
    <div className="flex-1 flex items-center justify-center p-4 bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="text-center max-w-md">
        ...
        {worldsLoading ? (
          ...
          <p className="text-slate-500 text-sm">{t("landing.noWorlds")}</p>
        )}

        <p className="text-slate-400 text-xs mt-6">{t("landing.footer")}</p>
      </div>
