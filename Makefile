...
dev:
	...
	@echo "   Still Python-only (Phase 3): the /rooms, /agents and /messages chat-room"
	@echo "   surface, SSE streaming, the autonomous-round scheduler, the agent-file"
	@echo "   watcher, i18n and image upload. Run 'make dev-python' if you need those."
	@echo ""
