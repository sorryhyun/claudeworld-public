...
from sdk.handlers.servers import create_onboarding_mcp_server
...
class TestCreateOnboardingTools:
    ...
    @patch("sdk.handlers.onboarding_tools.is_tool_enabled")
    @patch("sdk.handlers.onboarding_tools.get_tool_description")
...
class TestCreateOnboardingMCPServer:
    ...
    @patch("sdk.handlers.servers.create_onboarding_tools")
