...
                    │
                    ├── change_stat()                 → 스탯/인벤토리 변경
                    ├── Task(item_designer)       → 아이템 템플릿 생성
